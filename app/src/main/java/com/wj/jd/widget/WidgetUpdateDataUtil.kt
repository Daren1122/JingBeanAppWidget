...
class WidgetUpdateDataUtil {
    ...
    private fun setData() {
        ...
        if ("1" == colorSwitch) {
            ...
            remoteViews.setTextColor(R.id.yesterDayTip, ColorUtil.transColor("#888888"))
            remoteViews.setTextColor(R.id.todayTip, ColorUtil.transColor("#888888"))
            ...
            remoteViews.setTextColor(R.id.yesterDayTip, Color.parseColor("#888888"))
